...
/**
 * 苏宁开放平台接口 - 商品API - 文化制品类商品内容修改
 *
 * $pack   suning.custom.book.itemcontents.modify
 * @author jerry(14033184@cnsuning.com)
 * @date   2014-05-29
 */

class BookItemcontentsModifyRequest extends SuningRequest
{
	/**
    ...
    public function check()
	{
        ...
        if (!RequestCheckUtil::checkEmpty($this->saleSet, 'saleSet')) {
