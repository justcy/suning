 ...
 * @date   2014-6-4
 */
class OrderdeliveryAddRquest extends SuningRequest{
	/**
	 * 订单号
	 */
	private $orderCode;
	...
	public function check()
	{
		...
		//日期格式校验
		if(!RequestCheckUtil::checkEmpty($this->deliveryTime)){
			RequestCheckUtil::checkDate($this->deliveryTime, "deliveryTime");
		}
