...
/**
 * 苏宁开放平台接口 - 库存API - 创建单个仓库（平行仓模式）
 *
 * $pack   suning.custom.parallelinvaddress.add
 * @author jerry(14033184@cnsuning.com)
 * @date   2014-05-30
 */

class ParallelinvaddressAddRequest extends SuningRequest
{
    /**
     * 仓库编码。商家自行编辑，需做唯一性校验，一旦确定不得进行更改
     */
    private $invCode;
    ...
    public function check()
	{
        ...
        RequestCheckUtil::checkNotNull($this->invName, 'invName');
        RequestCheckUtil::checkNotNull($this->invNameBack, 'invNameBack');
