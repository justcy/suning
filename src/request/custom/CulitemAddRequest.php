...
class CulitemAddRequest  extends SuningRequest{
	...
	public function check(){
		...
		RequestCheckUtil::checkNotNull($this->saleCatalogCode, 'saleCatalogCode');
		RequestCheckUtil::checkNotNull($this->saleSet, 'saleSet');
		RequestCheckUtil::checkNotNull($this->supplierImgAUrl, 'supplierImgAUrl');
		RequestCheckUtil::checkNotNull($this->supplierImgBUrl, 'supplierImgBUrl');
		RequestCheckUtil::checkNotNull($this->supplierImgCUrl, 'supplierImgCUrl');
		RequestCheckUtil::checkNotNull($this->supplierImgDUrl, 'supplierImgDUrl');
		RequestCheckUtil::checkNotNull($this->supplierImgEUrl, 'supplierImgEUrl');
	}
